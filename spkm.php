...
<div class="container container13">
    <div class="main1-top">
        <img style="margin-left: 430px" src="/dienthoai/Admin/QlyProduct/uploads/km.png">
    </div>
    <div class="main1-sp2">
        <?php foreach ($product_km as $item){ ?>
        <div class="slide">
            <a href="single-product.php?product_id=<?php echo $item['product_id'] ?>"><img style="width: 180px" src="/dienthoai/Admin/QlyProduct/uploads/<?php echo $item['product_img'];?>"></a>
            <p class="GG">-
