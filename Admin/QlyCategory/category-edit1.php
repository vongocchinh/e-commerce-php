...
if (!empty($_POST['edit_cafe']))
{
    ...
    if (!$errors){
        edit_category($data['cafe_id'], $data['cafe_name']);
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                     <form action="category-edit1.php"  method="post">
                                    
                                        <thead>
                                            <tr>
                                <td class="name-edit"><p>Tên Hãng</p></td>
                                <td>
                                    <input class="input" type="text" name="name" value="<?php echo $data['category_name']; ?>" />
